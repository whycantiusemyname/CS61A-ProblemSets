...
def boar_brawl(player_score, opponent_score):
    ...
    boar_brawl_point = 3 * abs(opponent_digit - player_digit)
    if not boar_brawl_point:
        return 1
    return boar_brawl_point
    # END PROBLEM 2
...
def always_roll(n):
    ...
    # BEGIN PROBLEM 6
    "*** YOUR CODE HERE ***"
    def strategy(player_score,oppoent_score):
        return n
    return strategy
    # END PROBLEM 6
...
def max_scoring_num_rolls(dice=six_sided, samples_count=1000):
    ...
    roll_num = 0
    for i in range(1,11):
        result = average_roll_dice(i,dice)
        if result > max_score:
            max_score = result
            roll_num = i
    return roll_num      
